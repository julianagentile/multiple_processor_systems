...
//Jason Lowden
//October 26, 2013
//This file contains a C-style interface used to access the ray tracing engine.
//The engine itself is written in C++ and this is the abstraction that I have
//define so far. There is no requirement to know C++.
//
...
// for dynamic configuration use a queue
struct DynamicUnit {
    int startRow;
    int startCol;
    int blockWidth;
